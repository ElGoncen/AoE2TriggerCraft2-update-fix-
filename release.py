...
def git_last_commit_date(path):
    try:
        ...
        # Si no es un repositorio git o hay error, devolvemos la fecha de hoy
...
def get_version(path):
    try:
        ...
        # Puedes poner la versión que tú quieras aquí
        versionString = f"2.0.0 ({date})"
        versionTuple = (2, 0, 0, 0)
        return versionString, versionTuple
    except Exception:
        return "2.0.0 (Custom)", (2, 0, 0, 0)
