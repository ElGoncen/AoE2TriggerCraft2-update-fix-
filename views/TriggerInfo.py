...
class TriggerInfoView(ttk.Frame):
    ...
    def __init__(self, app: TCWindow, master = None, **kwargs):
        ...
        cbTEnable = ttk.Checkbutton(self, text=TEXT['btnTriggerEnable'], bootstyle=("success-round-toggle"),
        ...
        cbTLoop = ttk.Checkbutton(self, text=TEXT['btnTriggerLoop'], bootstyle=("success-round-toggle"),
        ...
        cbTExecuteOnLoad = ttk.Checkbutton(self, text=TEXT['btnTriggerExecuteOnLoad'], bootstyle=("success-round-toggle"),
        ...
        cbTMakeHeader = ttk.Checkbutton(fTOthers, text=TEXT['btnTriggerMakeHeader'], bootstyle=("success-round-toggle"),
                                            variable=self.varTMakeHeader, command=self.__setTriggerMakeHeader)
        cbTMakeHeader.pack(side=LEFT)
        cbTMuteObjective = ttk.Checkbutton(fTOthers, text=TEXT['btnTriggerMuteObjective'], bootstyle=("success-round-toggle"),
        ...
        cbTAsObjective = ttk.Checkbutton(self, text=TEXT['btnTriggerAsObjective'], bootstyle=("success-round-toggle"),
        ...
        cbTOnScreen = ttk.Checkbutton(self, text=TEXT['btnTriggerOnScreen'], bootstyle=("success-round-toggle"),
